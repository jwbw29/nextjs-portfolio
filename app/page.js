  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 border border-red-500 border-solid">
      <div className=" max-w-7xl w-full items-left justify-between text-sm lg:flex flex-col border-2 border-blue-500 border-solid">
        <h1 className="border border-solid border-black">
        ...
        <h2 className="border border-dashed border-black ">About Me</h2>
        <h2 className="border border-dashed border-black">
          Project 1(maybe only one until CMS gets installed)
        </h2>
        <h2 className="border border-dashed border-black">Project 2</h2>
        <h2 className="border border-dashed border-black">Project 3</h2>
      </div>
    </main>
  );
}
